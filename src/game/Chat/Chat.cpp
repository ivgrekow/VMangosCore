...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand partyBotCommandTable[] =
    {
        ...
        { "caststart",  SEC_PLAYER,      false, &ChatHandler::HandlePartyBotStartCastingCommand, "", nullptr },
        { "caststop",   SEC_PLAYER,      false, &ChatHandler::HandlePartyBotStopCastingCommand, "", nullptr },
